...
import { limitScale } from '../utis/limitTarget';
import { BrokenElementParams, DataType, ExposedProperties, PhotoTapFunction, ReachFunction, ReachMoveFunction, ReachType, TouchStartType } from '../utis/type';
import { minStartTouchOffset, scaleBuffer } from '../utis/variables';
